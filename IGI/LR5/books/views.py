...
class StatisticsView(StaffRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        logger.debug(f"Genre Labels: {genre_labels}")
        logger.debug(f"Genre Data: {genre_data}")
        logger.debug(f"Age Labels: {age_labels}")
        logger.debug(f"Age Data: {age_data}")
